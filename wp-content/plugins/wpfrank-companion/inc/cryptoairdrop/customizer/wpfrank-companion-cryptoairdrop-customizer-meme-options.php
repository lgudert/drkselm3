...
function wpfrank_cryptoairdrop_frontpage_sections_settings( $wp_customize ) {
	...
	$wp_customize->add_section(
		...
		$wp_customize->add_setting(
			...
			array(
				'default'           => wpfrank_companion_plugin_url . '/inc/cryptoairdrop/img/meme-token-slide.png',
	...
	$wp_customize->add_section(
		...
		$wp_customize->add_setting(
			...
			array(
				'default'           => wpfrank_companion_plugin_url . '/inc/cryptoairdrop/img/meme-token-about.png',
				'sanitize_callback' => 'esc_url_raw',
			)
		);
	...
	$wp_customize->add_setting(
		...
		array(
			'default'           => wpfrank_companion_plugin_url . '/inc/cryptoairdrop/img/meme-token-feature.png',
			'sanitize_callback' => 'esc_url_raw',
		)
	);
...
function wpfrank_cryptoairdrop_Customizer_selective_refresh_settings( $wp_customize ) {
	...
	$wp_customize->add_setting(
		...
		array(
			'default'           => __( 'NEW GENERATION MEME COIN', 'cryptoairdrop' ),
	...
	$wp_customize->add_setting(
		...
		array(
			'default'           => __( 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'cryptoairdrop' ),
			'sanitize_callback' => 'sanitize_text_field',
			'transport'         => $selective_refresh,
		)
	);
	...
	$wp_customize->add_setting(
		...
		array(
			'default'           => __( 'A NEW GEN COIN', 'cryptoairdrop' ),
			'sanitize_callback' => 'sanitize_text_field',
			'transport'         => $selective_refresh,
		)
	);
	...
	$wp_customize->add_setting(
		...
		array(
			'default'           => __( 'ALL ABOUT MEME COIN', 'cryptoairdrop' ),
			'sanitize_callback' => 'sanitize_text_field',
			'transport'         => $selective_refresh,
		)
	);
	...
	$wp_customize->add_setting(
		...
		array(
			'default'           => __( 'Why MEME COIN?', 'cryptoairdrop' ),
			'sanitize_callback' => 'sanitize_text_field',
		// 'transport'           => $selective_refresh,
		)
	);
	...
	$wp_customize->add_setting(
		...
		array(
			'default'           => __( 'Progress Map', 'cryptoairdrop' ),
			'sanitize_callback' => 'sanitize_text_field',
		)
	);
	$wp_customize->add_control(
