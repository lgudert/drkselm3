				...
				<div class="tab-content" id="nav-tabContent">
							...
							<div class="col-md-6 p-2 mt-3 border">
								...
								<div>
									...
									<div id="csmm-website-mode-info" class="form-text">
										...
										<strong><?php esc_html_e( 'Check Live Preview', 'coming-soon-maintenance-mode' ); ?></strong> <?php esc_html_e( 'button is used to check website as visitor only for admin.', 'coming-soon-maintenance-mode' ); ?>
						...
						<div class="row">
							...
							<div class="col-md-6 p-2 mt-3 border">
								...
								<div>
									...
									<div id="csmm-countdown-timezone-info" class="form-text"><?php esc_html_e( 'Timezone setting used to calculate website lauch.', 'coming-soon-maintenance-mode' ); ?></div>
									...
									<div class="form-text"><span class="badge text-bg-danger"><?php esc_html_e( 'Important Note', 'coming-soon-maintenance-mode' ); ?></span><br><?php esc_html_e( 'Automatice website lauch on countdown end available only in Pro version.', 'coming-soon-maintenance-mode' ); ?></div>
								</div>
							</div>
						</div>
					...
					<div class="tab-pane fade" id="nav-social-media" role="tabpanel" aria-labelledby="nav-social-media-tab" tabindex="0">
						<div class="row">
							<div class="col-6 p-2 mt-3 border bg-light">
								...
								<div>
									<div class="input-group p-2 mt-3">
										<a href="https://webenvo.com/coming-soon-maintenance-mode-pro/" target="_blank"><span class="badge text-bg-warning">More Social Media options are available in Pro</span></a>
									</div>
								</div>
								<div>
									<div class="input-group p-2 mt-3">
					...
					<div class="tab-pane fade" id="nav-docs" role="tabpanel" aria-labelledby="nav-docs-tab" tabindex="0">
						<div class="row">
							<div class="col-6 p-2 mt-3 border">
								<div id="csmm-website-mode-info" class="form-text">
									<h5 class=""><?php esc_html_e( 'Have problem with the plugin?', 'coming-soon-maintenance-mode' ); ?></h5>
								...
								<div id="csmm-website-mode-info" class="form-text">
									...
									<?php esc_html_e( 'Upgrape plugin to Pro version to get more templates and features.', 'coming-soon-maintenance-mode' ); ?>
