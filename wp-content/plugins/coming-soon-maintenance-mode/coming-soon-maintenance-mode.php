...
/**
 * Plugin Name:       Coming Soon Maintenance Mode - v1.0.2
...
function csmm_menu_page() {
	...
	add_menu_page( __( 'Coming Soon Maintenance Mode', 'csmm' ), __( 'Coming Soon Maintenance Mode', 'coming-soon-maintenance-mode' ), 'manage_options', 'webenvo-csmm', 'webenvo_csmm', 'dashicons-format-gallery', 3 );
}
